...
class Circuit:
    ...
    def _build_node_index(self):
        ...
        Uses each component's NODE_KEYS class attribute to discover which
        data-dict keys hold node references. This eliminates the need for a 
        hardcoded key list and automatically supports new component types.
        """
        nodes = set()
        
        for comp in self.components:
            # Each component class declares its own node keys
            for key in comp.NODE_KEYS:
    ...
    def get_component(self, name):
        ...
        Args:
            name (str): The netlist component name (e.g., 'V1', 'R_LOAD').
