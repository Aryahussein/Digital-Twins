...
class AdjointEngine:
    ...
    def compute_transient(self, time_array, V_forward, list_of_lus, dt, method='BE'):
        ...
        tensor = SensitivityData(time_array, param_names, self.output_nodes, domain="time")
        ...
        for target_node in self.output_nodes:
            ...
            for i in range(num_steps):
                ...
                for comp in self.circuit.components:
                    step_sens = comp.get_sensitivities(VI=vi_step, PsiPhi=v_hat_step, dt=dt, V_prev=vi_prev, method=method)
    ...
    # ====================================================
    def compute_sensitivities(self, sweep_axis, V_forward, list_of_lus, domain="static", method="TR", dt=0.0):
